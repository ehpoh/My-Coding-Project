...
public class Staff_ForgotPasswordPage {
    ...
    public Staff_ForgotPasswordPage() {
    ...
    private JPanel createInputPanel() {
        ...
        JTextField idField = GUI.createPlaceholderTextField("Enter staff ID", 150, 60, 200, 25);
        panel.add(idField);
        ...
        submitBtn.addActionListener(e -> {
            ...
            boolean isIDDefault = id.equals("Enter staff ID");
            boolean isPhoneDefault = phone.equals("Enter 01x-xxx-xxxx or 01x-xxxx-xxxx");

            if (id.isEmpty() && phone.isEmpty() || isIDDefault && isPhoneDefault) {
            ...
            if (StaffFileManager.isStaffExists(id)) {
                if (StaffFileManager.checkStaffPhoneNumber(id, phone)) {
                    this.staffID = id;
                ...
                messageLabel.setText("Staff ID not found.");
            }
        });
    ...
    private JPanel createNewPasswordPanel() {
        ...
        updateBtn.addActionListener(e -> {
            ...
            if (StaffFileManager.updateStaffPassword(staffID, pass)) {
